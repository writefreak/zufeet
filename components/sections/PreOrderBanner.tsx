...
export default function PreOrderBanner() {
  return (
    <div className="bg-white/80">
      <section className="max-w-5xl py-6 md:py-18 mx-auto px-6 pb-16">
        <div className="relative bg-brand rounded-2xl overflow-hidden p-12 md:p-16 flex flex-col md:flex-row md:items-center justify-between gap-8">
          <div className="relative z-10">
            ...
            <p className="font-body text-white/80 pt-1 text-xs md:text-sm max-w-md leading-relaxed">
              ...
              <br className="hidden md:block" /> that your feet will thank you
              for.
            </p>
          </div>
